package com.example.cleanarchitecture_baemin.screen.review
...
import com.example.cleanarchitecture_baemin.databinding.ActivityAddRestaurantReviewBinding
import com.example.cleanarchitecture_baemin.widget.adapter.PhotoListAdapter
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.firestore.FirebaseFirestore
import com.google.firebase.storage.FirebaseStorage
import com.example.cleanarchitecture_baemin.screen.review.photo.CameraActivity
import com.example.cleanarchitecture_baemin.screen.review.gallery.GalleryActivity
...
class AddRestaurantReviewActivity : AppCompatActivity() {
    ...
    private fun afterUploadPhoto(results: List<Any>, title: String, content: String, rating: Float, userId: String) {
        ...
        when {
            errorResults.isNotEmpty() && successResults.isNotEmpty() -> {
                photoUploadErrorButContinurDialog(errorResults, successResults, title, content, rating, userId)
            }
    ...
    private fun uploadArticle(userId: String, title: String, content: String, rating: Float,  imageUrlList: List<String>) {
        val review = ReviewEntity(userId, title, System.currentTimeMillis(), content, rating, imageUrlList, orderId, restaurantTitle)
