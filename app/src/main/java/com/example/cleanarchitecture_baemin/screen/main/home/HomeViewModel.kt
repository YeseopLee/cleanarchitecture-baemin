...
class HomeViewModel(
    ...
    val foodMenuInBasketLiveData = MutableLiveData<List<RestaurantFoodEntity>>()
    ...
    fun checkMyBasket() = viewModelScope.launch {
        foodMenuInBasketLiveData.value = restaurantFoodRepository.getAllFoodMenuListInBasket()
    }
